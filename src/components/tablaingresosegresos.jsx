...
function tablaingresosegresos({ ingresosyegresos }) {
  ...
  return (
    <div className="overflow-auto rounded-t-md">
      ...
      <button className="border rounded-lg mt-1 p-2 w-full font-bold flex justify-center border-dotted items-center gap-1 cursor-pointer hover:border-sky-700 hover:text-sky-700">
        <IoIosAdd />
        Agregar
      </button>
    </div>
