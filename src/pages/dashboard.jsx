          ...
          <div className="overflow-x-auto w-full px-10 py-4">
            ...
            <div className="flex justify-end mb-4 text-sky-700 dark:text-slate-400">
              <input
                ...
                className="border dark:border-slate-800 bg-white dark:bg-slate-900 text-gray-700 dark:text-slate-200 px-3 py-2 rounded-lg w-64 focus:ring-2 focus:ring-sky-500 outline-none placeholder:text-gray-300 dark:placeholder:text-slate-600 transition-colors"
              />
            </div>
