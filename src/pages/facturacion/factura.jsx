...
import { getEmisores } from "../../request/emisores";
import { getSeriesByTipo } from "../../request/series";
import { getUnidades } from "../../request/unidades";
import { findClienteByDoc, createCliente } from "../../request/clientes";
import {
  createComprobante,
  createDetalle,
  emitirComprobante,
  getPdfUrl,
  getXmlUrl,
} from "../../request/comprobantes";
import axiosURL from "../../request/axiosURL";
  ...
  return (
    <div className="px-12 py-4 w-screen">
      <div className="flex justify-start gap-5 items-center">
        <Drawer />
        <div className="text-3xl font-black text-sky-800 dark:text-slate-100 transition-colors tracking-tight">Emitir Factura</div>
        {fromTicket && (
