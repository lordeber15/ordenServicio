 ...
 * 
 * Interfaz para la gestión y emisión de Guías de Remisión (Remitente/Transportista).
 */
function guiaremision() {
  return (
    <div className="w-screen bg-white dark:bg-slate-950 min-h-screen transition-colors">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center px-4 md:px-12 py-6 gap-6">
        <div className="flex items-center gap-5">
          <Drawer />
          <h1 className="text-3xl font-black text-sky-800 dark:text-slate-100 tracking-tight transition-colors">Guia de Remisión</h1>
        </div>
      ...
      <div className="px-12 py-20 flex flex-col items-center justify-center text-slate-400 dark:text-slate-600">
