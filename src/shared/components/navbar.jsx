...
function Navbar() {
  ...
  return (
    ...
    <div className="h-14 md:h-18 w-full bg-sky-700 dark:bg-slate-950 flex flex-row justify-between items-center px-4 sm:px-8 md:px-14 shadow-[0px_4px_6px_0px_rgba(0,_0,_0,_0.1)] text-white relative transition-colors duration-300 border-b dark:border-slate-800/50">
      {/* Logo de la empresa */}
      <img src={Logo} className="h-8 md:h-11" alt="Logo" />

      {/* Sección de usuario y menú dropdown */}
      <div className="flex items-center gap-2" ref={dropdownRef}>
        {/* Saludo personalizado - oculto en móvil */}
        <span className="hidden md:inline">Bienvenid@ {userData?.usuario} !</span>
        ...
        {open && (
          <div className="absolute right-0 mt-48 md:mt-55 mr-4 md:mr-14 w-40 bg-sky-600 dark:bg-slate-900 rounded-md shadow-lg py-2 z-10 animate-fade-down animate-duration-100 animate-ease-in border dark:border-slate-800">
