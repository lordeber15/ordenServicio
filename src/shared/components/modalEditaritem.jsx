...
import { getUnidades } from "../../modules/Billing/services/unidades";
...
function ModalEditaritem({ isOpen, onClose, setItems }) {
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-slate-900 p-6 rounded-md shadow-md w-full md:w-1/2 lg:w-1/3 border dark:border-slate-800">
