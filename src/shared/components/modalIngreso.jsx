...
import { createIngresos } from "../services/ingresosrequest";
import { createEgresos } from "../services/egresosrequest";
...
function ModalIngreso({ isOpen, onClose, titulo }) {
  ...
  return (
    <Modal
      ...
      ariaHideApp={false}
      className="bg-white dark:bg-slate-900 w-11/12 md:w-1/2 p-6 rounded-md shadow-md max-w-md mx-auto mt-15 border dark:border-slate-800"
